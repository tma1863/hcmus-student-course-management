 ...
 *
 * <p>The status is <em>derived from the score</em> by the service, never set by the client, so it
 * can never disagree with the recorded score:
 *
 * <ul>
 *   <li>{@link #ENROLLED} — registered for an open course, no score recorded yet (score is {@code
 *       null}).
